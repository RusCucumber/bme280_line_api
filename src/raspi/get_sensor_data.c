...
signed short int dig_H4;
signed short int dig_H5;
signed char dig_H6;
...
{
    signed long int var1;
    signed long int var2;
    signed long int T;
...
void get_sensor_data(void)
{
    ...
    unsigned char osrs_p = 1;
    unsigned char osrs_h = 1;
    unsigned char mode = 3;
    unsigned char t_sb = 5;
    unsigned char filter = 0;
    unsigned char spi3w_en = 0;
    ...
    // printf("TEMP: %f C, PRESS: %f hPa, HUM: %f \n", temp_act, press_act, hum_act);

    observation.temp = temp_act;
    observation.press = press_act;
    observation.humd = hum_act;
}
...
void get_sensor_data(void)
{
    observation.temp = 20.0;
    observation.press = 1000.0;
    observation.humd = 50.0;
}
*/